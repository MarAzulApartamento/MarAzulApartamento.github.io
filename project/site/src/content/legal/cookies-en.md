...
language: en
title: Cookie Policy
description: What cookies and similar technologies Apartamento Mar Azul uses on its website, and how to manage them.
lastUpdated: '2026-05-07'
---

This page explains what cookies are, what's set on **apartamentomarazul.com**, and how you can manage them. For the wider data protection picture, see the [Privacy Notice](/privacy/).

## What cookies are

Cookies are small text files that a website asks your browser to store. They help the site work, remember preferences, and (when used for that purpose) measure how it's used. Similar technologies include localStorage, sessionStorage, and pixel tags. We use the word "cookies" below to cover all of these.
...
You can clear cookies and block them through your browser settings:
...
Blocking cookies on third-party sites (like the Lodgify checkout) may break the booking flow. Blocking cookies on our site has no effect, because we don't set any.

## Contact

For questions about cookies, write to the privacy contact in the [Privacy Notice](/privacy/).
